...
import (
	...
	"github.com/itering/subscan/libs/substrate/hasher"
...
var (
	KtonTotalIssuance StorageKey
	KtonStakingPool   StorageKey
	RingStakingPoole  StorageKey
...
func SubscribeStorage() []string {
	...
	case util.CrabNetwork:
		KtonTotalIssuance = EncodeStorageKey("Kton", "TotalIssuance")
		KtonStakingPool = EncodeStorageKey("Staking", "RingPool")
		RingStakingPoole = EncodeStorageKey("Staking", "KtonPool")
		return []string{
			TotalIssuance.EncodeKey, KtonTotalIssuance.EncodeKey,
			KtonStakingPool.EncodeKey, RingStakingPoole.EncodeKey,
		}
	default:
		return []string{TotalIssuance.EncodeKey}
	}
}
