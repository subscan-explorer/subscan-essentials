...
func TestDao_DropExtrinsicNotFinalizedData(t *testing.T) {
	...
	testDao.DropExtrinsicNotFinalizedData(ctx, tempExtrinsic.BlockNum, tempExtrinsic.Finalized)
...
func TestDao_GetExtrinsicsDetailByIndex(t *testing.T) {
	...
	assert.Equal(t, "DPmDGJjQfnHgfeVrR29wrS5fttauHnrQALimWZFszQZnJTm", extrinsic.AccountId)
