...
func TestSubscribeParserMessage(t *testing.T) {
	...
	assert.Equal(t, 4, util.CurrentRuntimeSpecVersion)
	...
	assert.GreaterOrEqual(t, subscriptionIds[0].Latest, now)
	...
	assert.GreaterOrEqual(t, subscriptionIds[1].Latest, now)
