...
type Payout struct {
	...
	Account        string          `gorm:"index" sql:"default: null;size:100" json:"account"`
	Amount         decimal.Decimal `sql:"type:decimal(30,0);" json:"amount"`
	Era            uint32          `gorm:"index" json:"era"`
	Stash          string          `gorm:"index" sql:"default: null;size:100" json:"stash"`
	ValidatorStash string          `gorm:"index" sql:"default: null;size:100" json:"validator_stash"`
